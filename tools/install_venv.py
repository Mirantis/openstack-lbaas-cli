...
"""
Installation script for balancerclient development virtualenv
"""
...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import balancerclient"
...
def print_help():
    help = """
    python-balancerclient development environment setup is complete.

    python-balancerclient development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the python-balancerclient virtualenv for the extent of your current
